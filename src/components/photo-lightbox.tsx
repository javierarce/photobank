        ...
        <div className="flex w-72 shrink-0 flex-col gap-4 overflow-y-auto p-4">
          ...
          <div className="mt-auto flex flex-col gap-2">
            ...
            <button
              ...
              disabled={renaming}
              className="w-full rounded-md border border-border px-3 py-1.5 text-center text-sm transition hover:bg-foreground/5 active:scale-[0.97] disabled:opacity-50 disabled:pointer-events-none"
            >
              Download
            </button>
            {onDelete && (
